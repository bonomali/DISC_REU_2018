...
const NODE_PATH = "csv_files/nodes_doubly_classified.csv"
const LINK_PATH = "csv_files/weights-network-cell.csv"
...
d3.csv(NODE_PATH, function(nodes_data) {
	...
	d3.csv(LINK_PATH, function(links_data) {
