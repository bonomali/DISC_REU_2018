// added function to improve scope
function makeSunburst(){

const FLARE_FILE = "json_files/sunburst_data.json";
const SEQUENCE_FILE = "csv_files/sequence.csv"
...
d3.json(FLARE_FILE, function(error, root) {
  if (error) console.log("Bad flare");
...
function click(d) {
	...
	d3.csv(SEQUENCE_FILE , function(input){
		var matching = [];
