...
data_path = "../classifying_nodes/struc2vec-directed-classified99.csv"
...
def vector_gen(sequence, nodes_vector, struc_vector = struc128D, struc_type="struc2vec128D"):
	...
	for index in range(len(nodes_vector)):
		if nodes_vector[index] in sequence:
			...
			absence_vector[struc_vector.index(struc)] +=1
...
###  First off, do the cumulative view: grade vs structure
