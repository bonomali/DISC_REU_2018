...
def run_remote(int_network_file, out_embeddings_file):
	def parse_args():
		'''
		...
		parser.add_argument('--input', nargs='?', default=int_network_file,
		                    help='Input graph path')
		
		parser.add_argument('--output', nargs='?', default=out_embeddings_file,
	...
	def exec_struc2vec(args):
		...
		if(args.OPT1):
			...
			print("Create vectors + simulate distances")
		if(args.OPT2):
			print("Create vectors:")
			G.create_vectors()
			print("Simulate distances:")
